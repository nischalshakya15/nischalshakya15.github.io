...
javaOneTopTwoStudent <- bind_rows(javaOneTwoExcellentStudent, javaOneTwoVeryGoodStudent, javaOneTwoGoodStudent, javaOneTwoStatisfactoryStudent)

javaOneTopTwoStudent <- javaOneTopTwoStudent %>% select(Name, Gender, Assignment.Marks.Obtained, Mid.Term.Fifteen.Percent.Marks.Obtained, Lab.Test.Fifteen.Percent.Marks.Obtained, Final.Exam.Forty.Percent.Marks, Total, Rank)
# End
```